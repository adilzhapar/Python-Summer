...
display = Label(root, text='0', bg='#808080', font='Tahoma 20', bd=10)
display.grid(row=0, column=0, columnspan=4)

for row in range(4):
    for column in range(4):
        button = Button(root, text=buttons[row][column], font='Tahoma 20', bg='#808080', command=lambda text=buttons[row][column]: click(text))
